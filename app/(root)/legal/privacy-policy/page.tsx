...
export const metadata: Metadata = {
  ...
  description: "Learn about how Syntax Spring collects, uses, and protects your personal information.",
}
    ...
    <div className="container py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="text-lg text-muted-foreground mb-6">Last updated: March 13, 2025</p>

          <h2>Introduction</h2>
          <p>
            At Syntax Spring, we take your privacy seriously. This Privacy Policy explains how we collect, use,
            disclose, and safeguard your information when you visit our website and use our services. Please read this
          ...
          <ul>
            <li>
              <strong>Personal Information:</strong> Name, email address, and profile picture.
            </li>
            <li>
              <strong>Account Information:</strong> Username, password, and account preferences.
            </li>
            <li>
              <strong>Usage Data:</strong> Information about how you use our platform, including completed challenges,
          ...
          <ul>
            ...
            <li>
              The right to request that your personal data be erased where it is no longer necessary for us to retain
              such data
            </li>
            <li>
              The right to withdraw your consent to the processing at any time, where we rely on your consent to process
          ...
          <p>
            ...
            <a href="mailto:privacy@syntaxspring.com">privacy@syntaxspring.com</a>.
          </p>
